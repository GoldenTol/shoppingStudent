...
<%
	...
	Product bean = dao.getDataByPk02(num);
				...
				<tr>
					<td class="col-lg-5">
						<div class="card" style="width: 30rem;">
							<img src="./../image/${bean.image01}" class="card-img-top active_image" alt="${bean.name}">
						</div>
					</td>
					<td class="col-lg-1">
						<img src="./../image/${bean.image01}" class="card-img-top small_image" alt="${bean.name}">
						
						<c:if test="${not empty bean.image02}">
							<img src="./../image/${bean.image02}" class="card-img-top small_image" alt="${bean.name}">
						</c:if>
						
						<c:if test="${not empty bean.image03}">
							<img src="./../image/${bean.image03}" class="card-img-top small_image" alt="${bean.name}">
						</c:if>
