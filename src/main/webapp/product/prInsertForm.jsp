...
<body>
	...
	<form action="<%=WithFormTag%>" method="post" enctype="multipart/form-data">
		...
		<div class="input-group" id="productNum">
		...
		<div class="input-group">
  		  <span class="input-group-text col-md-2">상품명</span>
   		  <input id="name" name="name" type="text" class="form-control" placeholder="" value="패션01">
		</div>
		<div class="input-group">
  		  <span class="input-group-text col-md-2">제조 회사</span>
   		  <input id="company" name="company" type="text" class="form-control" placeholder="" value="씨디이에프">
		</div>
		<div class="input-group">
  		  <span class="input-group-text col-md-2">코멘트</span>
   		  <input id="comments" name="comments" type="text" class="form-control" placeholder="" value="예쁘고 착한가격 짱짱입니다.">
		</div>
		<div class="input-group">
