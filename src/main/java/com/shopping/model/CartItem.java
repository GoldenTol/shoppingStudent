...
// 카트에 담은 상품1개에 대한 정보를 저장하고 있는 클래스
public class CartItem {
	...
	public CartItem(String mid, int pnum, String pname, int qty, int price, String image01, int point) {
		super();
		this.mid = mid;
		this.pnum = pnum;
		this.pname = pname;
	...
	public String getImage01() {return image01;}
	public void setImage01(String image01) {this.image01 = image01;}
